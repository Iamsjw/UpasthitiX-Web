    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="p-5 rounded-2xl bg-zinc-900 border border-zinc-800">
          ...
          <p className="text-xs text-zinc-500 mt-1">Database session records</p>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-zinc-900 border border-zinc-800">
          ...
          <p className="text-xs text-zinc-500 mt-1">Closed attendance logs</p>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-zinc-900 border border-zinc-800">
          ...
          <p className="text-3xl font-bold text-white">{activeSession ? 1 : 0}</p>
          <p className="text-xs text-zinc-500 mt-1">Live active sessions</p>
        </div>
      </div>
      ...
      <div className="p-6 rounded-2xl bg-zinc-900 border border-zinc-800">
        <div className="flex items-center justify-between mb-5">
          <h3 className="text-base font-bold text-white">Recent Completed Sessions (Database)</h3>
          <Link href="/dashboard/teacher/sessions" className="text-xs font-bold text-indigo-400 hover:underline">
            View All
          </Link>
        </div>
          ...
          <div className="space-y-3">
            {sessions.map((s) => (
              ...
              >
                ...
                <span className="px-3 py-1 text-[11px] font-bold text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 rounded-lg flex items-center gap-1.5">
