      ...
      {activeSession ? (
        ...
        <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-3 text-zinc-400">
            ...
            <span>No active session currently broadcasting in database.</span>
          </div>
          <Link
            href="/dashboard/teacher/sessions"
            className="px-3.5 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-[11px] rounded-lg transition-all w-fit"
          >
            + Start Web Class Session
          </Link>
        </div>
      )}
